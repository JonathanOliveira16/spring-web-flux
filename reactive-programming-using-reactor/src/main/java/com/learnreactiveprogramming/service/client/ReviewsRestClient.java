...
import com.learnreactiveprogramming.service.domain.Review;
...
import com.learnreactiveprogramming.service.exception.ReviewsClientException;
import com.learnreactiveprogramming.service.exception.ReviewsServerException;
...
public class ReviewsRestClient {
    ...
    public Flux<Review> retrieveReviews(String movieId){
        ...
        var url = UriComponentsBuilder.fromHttpUrl(reviewsUrl).queryParam("movieInfoId", movieId)
        ...
        return webClient.get().uri(url).retrieve()
                .onStatus(HttpStatus::is4xxClientError, clientResponse -> {
                    ...
                    log.info("Status code is :{} ", clientResponse.statusCode().value());
                    return clientResponse.bodyToMono(String.class).flatMap(responseMessage ->
                            Mono.error(new ReviewsServerException("Server Exception in ReviewsService" +responseMessage)));
