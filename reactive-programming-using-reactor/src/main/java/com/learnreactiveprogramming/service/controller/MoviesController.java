package com.learnreactiveprogramming.service.controller;

import com.learnreactiveprogramming.service.client.MoviesInfoRestClient;
import com.learnreactiveprogramming.service.client.ReviewsRestClient;
...
public class MoviesController {
    ...
    public Mono<Movie> retrieveMovieById(@PathVariable("id") String movieId){
        return moviesInfoRestClient.retrieveMovieInfo(movieId).flatMap(movieInfo -> {
